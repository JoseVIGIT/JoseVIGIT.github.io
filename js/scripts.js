...
document.getElementById("contenido").addEventListener("touchstart", desplazaIni);
document.getElementById("contenido").addEventListener("touchend", desplazaFin);
